...
int nodeIterator2Dref(const std::string& fileName) {
	...
	std::vector<std::vector<int>> expFace3 = {
		...
		{225,250,255,230},{230,255,260,235}, //20-24
	...
	std::vector<std::vector<int>> expFace5 = {
		...
		{176,231,232,177},{177,232,233,178}, 
		{178,233,234,179},{179,234,235,180},	//12-15

		{231,256,257,232},{232,257,258,233}, //16-19
		{233,258,259,234},{234,259,260,235},
